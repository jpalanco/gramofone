/*
 * Atheros DB120 reference board with AK4430 extension support
 *
...
static struct gpio_keys_button db120_ak4430_gpio_keys[] __initdata = {
	{
		.desc		= "WPS button",
		.type		= EV_KEY,
		.code		= KEY_WPS_BUTTON,
...
static struct ar8327_pad_cfg db120_ak4430_ar8327_pad0_cfg = {
...
static struct ar8327_platform_data db120_ak4430_ar8327_data = {
	.pad0_cfg = &db120_ak4430_ar8327_pad0_cfg,
	.cpuport_cfg = {
		.force_link = 1,
...
static struct mdio_board_info db120_ak4430_mdio0_info[] = {
	{
		.bus_id = "ag71xx-mdio.0",
		.phy_addr = 0,
		.platform_data = &db120_ak4430_ar8327_data,
	},
};

static struct platform_device db120_ak4430_spdif_codec = {
	.name		= "ak4430-codec",
	.id		= -1,
};

static struct platform_device db120_ak4430_internal_codec = {
	.name		= "ath79-internal-codec",
	.id		= -1,
};

static void __init db120_ak4430_gmac_setup(void)
{
	void __iomem *base;
	u32 t;
...
static void __init db120_ak4430_audio_setup(void)
{
	u32 t;
...
static void __init db120_ak4430_setup(void)
{
	...
	mdiobus_register_board_info(db120_ak4430_mdio0_info,
				    ARRAY_SIZE(db120_ak4430_mdio0_info));
	...
	db120_ak4430_audio_setup();
	platform_device_register(&db120_ak4430_spdif_codec);
	platform_device_register(&db120_ak4430_internal_codec);
	ath79_audio_device_register();
}

MIPS_MACHINE(ATH79_MACH_DB120_AK4430, "DB120AK4430",
