...
fixup_interface() {
	...
	# Optimization for fon2415: this ubus call will always return 0 since
	# network interfaces have already been reloaded at this point, but it is
	# blocking and delaying networking mode changes
