...
$(call KernelPackage/ipt/Depends,)
  ...
  FILES:=$(foreach
  mod,$(IPT_NFQUEUE-m),$(LINUX_DIR)/net/$(mod).$(LINUX_KMOD_SUFFIX))
  AUTOLOAD:=$(call AutoLoad,50,$(notdir $(IPT_NFQUEUE-m)))
endef
