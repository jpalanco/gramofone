...
define KernelPackage/sound-soc-db120-ak4430
  TITLE:=Qualcomm-Atheros DB12x AK4430 sound support
  KCONFIG:= \
	CONFIG_SND_ATH79_SOC \
	CONFIG_SND_ATH79_SOC_I2S \
	CONFIG_SND_AK4430_SOC_CODEC \
	CONFIG_SND_ATH79_SOC_CODEC \
	CONFIG_SND_ATH79_SOC_DB120_AK4430 
  FILES:= \
	$(LINUX_DIR)/sound/soc/ath79/snd-soc-ath79-i2s.ko \
	$(LINUX_DIR)/sound/soc/ath79/snd-soc-ath79-pcm.ko \
	$(LINUX_DIR)/sound/soc/codecs/snd-soc-ak4430.ko \
	$(LINUX_DIR)/sound/soc/ath79/snd-soc-ath79-codec.ko \
	$(LINUX_DIR)/sound/soc/ath79/snd-soc-db120-ak4430.ko
  AUTOLOAD:=$(call AutoLoad,60,snd-soc-ath79-i2s snd-soc-ath79-pcm \
				snd-soc-ak4430 snd-soc-ath79-codec \
				snd-soc-db120-ak4430)
  DEPENDS:=@TARGET_ar71xx +kmod-sound-soc-core +kmod-regmap
  $(call AddDepends/sound)
endef

$(eval $(call KernelPackage,sound-soc-db120-ak4430))

define KernelPackage/sound-soc-ap123-ak4430
  TITLE:=Qualcomm-Atheros AP123 AK4430 sound support
  KCONFIG:= \
	CONFIG_SND_ATH79_SOC \
	CONFIG_SND_ATH79_SOC_I2S \
	CONFIG_SND_AK4430_SOC_CODEC \
	CONFIG_SND_ATH79_SOC_CODEC \
	CONFIG_SND_ATH79_SOC_AP123_AK4430 
  FILES:= \
	$(LINUX_DIR)/sound/soc/ath79/snd-soc-ath79-i2s.ko \
	$(LINUX_DIR)/sound/soc/ath79/snd-soc-ath79-pcm.ko \
	$(LINUX_DIR)/sound/soc/codecs/snd-soc-ak4430.ko \
  ...
  AUTOLOAD:=$(call AutoLoad,60,snd-soc-ath79-i2s snd-soc-ath79-pcm \
				snd-soc-ak4430 snd-soc-ath79-codec \
				snd-soc-ap123-ak4430)
  DEPENDS:=@TARGET_ar71xx +kmod-sound-soc-core +kmod-regmap
  $(call AddDepends/sound)
endef

$(eval $(call KernelPackage,sound-soc-ap123-ak4430))

define KernelPackage/sound-soc-ap123-tb388
  TITLE:=Qualcomm-Atheros AP123 TB388 sound support
  KCONFIG:= \
	CONFIG_SND_ATH79_SOC \
	CONFIG_SND_ATH79_SOC_I2S \
	CONFIG_SND_ATH79_SOC_CODEC \
	CONFIG_SND_ATH79_SOC_AP123_TB388 
  FILES:= \
	$(LINUX_DIR)/sound/soc/ath79/snd-soc-ath79-i2s.ko \
	$(LINUX_DIR)/sound/soc/ath79/snd-soc-ath79-pcm.ko \
	$(LINUX_DIR)/sound/soc/ath79/snd-soc-ath79-codec.ko \
	$(LINUX_DIR)/sound/soc/ath79/snd-soc-ap123-tb388.ko
  AUTOLOAD:=$(call AutoLoad,60,snd-soc-ath79-i2s snd-soc-ath79-pcm \
				snd-soc-ath79-codec \
				snd-soc-ap123-tb388)
  DEPENDS:=@TARGET_ar71xx +kmod-sound-soc-core +kmod-regmap
...
$(eval $(call KernelPackage,sound-soc-ap123-tb388))

define KernelPackage/sound-soc-fon2415
  TITLE:=FON2415 sound support
  KCONFIG:= \
	CONFIG_SND_ATH79_SOC \
	CONFIG_SND_ATH79_SOC_I2S \
	CONFIG_SND_AK4430_SOC_CODEC \
	CONFIG_SND_ATH79_SOC_CODEC \
	CONFIG_SND_ATH79_SOC_FON2415 
  FILES:= \
	$(LINUX_DIR)/sound/soc/ath79/snd-soc-ath79-i2s.ko \
	$(LINUX_DIR)/sound/soc/ath79/snd-soc-ath79-pcm.ko \
	$(LINUX_DIR)/sound/soc/codecs/snd-soc-ak4430.ko \
	$(LINUX_DIR)/sound/soc/ath79/snd-soc-ath79-codec.ko \
	$(LINUX_DIR)/sound/soc/ath79/snd-soc-fon2415.ko
  AUTOLOAD:=$(call AutoLoad,60,snd-soc-ath79-i2s snd-soc-ath79-pcm \
				snd-soc-ak4430 snd-soc-ath79-codec \
				snd-soc-fon2415)
  DEPENDS:=@TARGET_ar71xx +kmod-sound-soc-core +kmod-regmap
...
$(eval $(call KernelPackage,sound-soc-fon2415))
